...
namespace LTLM.SDK.Demos
{
    ...
    public class UnifiedAuthDemoUI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // Initialize the high-level Auth system
            _auth = new CustomerLogin(LTLMManager.Instance.GetClient());
        ...
        private void OnSendOtpClicked()
        {
            ...
            _auth.RequestOTP(emailInput.text, 
        ...
        private void OnVerifyOtpClicked()
        {
            ...
            _auth.VerifyOTP(emailInput.text, otpInput.text, 
                portfolio => {
